 ...
 ?>
    ...
    public function getLinkedInErrors() {
            ...
            if ( empty( $clientId ) || empty( $clientSecret ) ) {
                return array(
                    'text' => sprintf( __('You need to get LinkedIn Client ID and Secret for your website. Please <a href="%s" target="_blank">click here</a> to learn more.', 'signinlocker'), admin_url('admin.php?page=settings-bizpanda&opanda_screen=social') )
                );
            }
