                ...
                $emailFormOptions['items'][] = array(
                    ...
                    'items' => array(
                        array(
                            ...
                            'title' => __('Above Text', 'emaillocker'),
                            'hint' => 'The text above the buttons.',
                            'default' => 'subscribe via your social profile by one click'
                        ),
                        array(
                            'type' => 'list',
                            'way' => 'checklist',
                            ...
                            'data' => array(
                                array('facebook', __('Facebook', 'optinpanda')),
                                array('google', __('Google', 'optinpanda')),
                                array('linkedin', __('LinkedIn', 'optinpanda'))     
                            ),
                            'default' => 'facebook,google,linkedin',
                            'errors' => array($this, 'getSocialErros'),
                            'title' => __('Social Networks', 'optinpanda'),
                            'hint' => 'Mark available social networks.'
                        )
                    )
                );  
