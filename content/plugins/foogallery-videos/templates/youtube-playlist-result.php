	...
	echo '<div class="foovideo-result foovideo-playlist">';
		...
		echo '<div class="foovideo-details">';
			...
			echo '<div class="foovideo-meta">';
				echo __('by', 'foo-video' ) . ' ' .  $isplaylist['author_name'];
				echo ' &bull; ' . sprintf( _n( '%s view', '%s views', $results['views'], 'foo-video' ), $results['views'] );
				echo ' &bull; ' . sprintf( _n( '%s video', '%s videos', count( $results['video'] ), 'foo-video' ), count( $results['video'] ) );
			echo '</div>';
